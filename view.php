...
if (isset($_POST['msg']) && !empty($_POST['msg'])) {
    ...
    $stmt = $pdo->prepare('INSERT INTO tickets_comments (ticket_id,user_id, msg) VALUES (?,?, ?)');
    $stmt->execute([$_GET['id'], 2, $_POST['msg']]);
    header('Location: view.php?id=' . $_GET['id']);
    exit;
}
...
<div class="content view">
    ...
    <div class="btns">
        <!-- <a href="view.php?id=<?= $_GET['id'] ?>&status=closed" class="btn red">تا 24 ساعت پس از ارسال اخرین تیکت، نمیتوانید تیکت دیگری ارسال کنید</a> -->
        <a href="#" class="btn red">تا 24 ساعت پس از ارسال اخرین تیکت، نمیتوانید تیکت دیگری ارسال کنید</a>
    </div>
